const questions = [
    {
        question: "1. O que combina mais com você, joias de ouro ou de prata?",
        answers: [
            { text: "O ouro deixa minha pele com um brilho radiante e quente.", score: { warm: 2, cool: 0 } },
            { text: "A prata deixa minha pele com uma aparência clara e sofisticada.", score: { warm: 0, cool: 2 } }
        ]
    },
    {
        question: "2. Como sua pele reage depois de muito tempo exposta ao sol?",
        answers: [
            { text: "Bronzeia com facilidade em vez de ficar vermelha.", score: { warm: 1, cool: 0 } },
            { text: "Fica vermelha ou queima com facilidade.", score: { warm: 0, cool: 1 } }
        ]
    },
    {
        question: "3. Qual é a primeira impressão que você costuma passar?",
        answers: [
            { text: "Uma imagem calma, suave e acolhedora.", score: { warm: 1, cool: 0 } },
            { text: "Uma imagem clara, nítida e sofisticada.", score: { warm: 0, cool: 1 } }
        ]
    },
    {
        question: "4. A que se aproxima mais a cor natural do seu cabelo ou olhos?",
        answers: [
            { text: "Castanho suave ou castanho claro quente.", score: { warm: 1, cool: 0 } },
            { text: "Preto intenso ou castanho muito escuro.", score: { warm: 0, cool: 1 } }
        ]
    }
];

const results = {
    spring: { title: "Spring Warm", desc: "Você tem uma energia vibrante e quente (Primavera)! Pêssego, coral e caramelo mel são suas melhores cores.", colors: ["#FF6B6B", "#FFD93D", "#6BCB77", "#4D96FF"] },
    summer: { title: "Summer Cool", desc: "Você tem uma aura clara, fresca e elegante (Verão)! Lavanda e azul-celeste combinam perfeitamente com você.", colors: ["#E8A0BF", "#B9F3FC", "#A7BBC7", "#E1E5EA"] },
    autumn: { title: "Autumn Warm", desc: "Você projeta uma atmosfera profunda, rica e sofisticada (Outono)! Tons terrosos como cáqui e bordô maximizam seu charme.", colors: ["#826F66", "#B85C38", "#5C3D2E", "#E0C097"] },
    winter: { title: "Winter Cool", desc: "Você tem um estilo moderno, nítido e carismático (Inverno)! Preto puro, branco e tons vivos como azul-marinho destacam seus traços.", colors: ["#000000", "#FFFFFF", "#1A1A40", "#7A0BC0"] }
};
...
function showResult(forcedTone = null) {
    ...
    document.getElementById('best-color-title').innerText = "Sua Melhor Paleta de Cores";
    document.getElementById('match-guide-title').innerText = "Guia de Estilo e Combinações";
