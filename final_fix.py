...
lang_config = {
    'ko': {
        ...
        'celeb_desc': '<li><span style="color:#ff7675;font-weight:bold;">봄 웜톤:</span> 아이유, 수지</li><li><span style="color:#74b9ff;font-weight:bold;">여름 쿨톤:</span> 손예진, 태연</li><li><span style="color:#b2bec3;font-weight:bold;">가을 웜톤:</span> 제니, 효리</li><li><span style="color:#6c5ce7;font-weight:bold;">겨울 쿨톤:</span> 카리나, 선미</li>',
        ...
        'upload_title': '📸 AI 스마트 분석 및 진단 (Beta)', 'upload_desc': '정확한 분석을 위해 얼굴이 정면으로 잘 나온 밝은 사진을 사용해 주세요. 데이터는 외부 서버에 절대 저장되지 않습니다.', 
        'upload_btn': '실시간 카메라 작동하기', 'file_select_btn': '📁 기존 사진 업로드하기',
        'js_best_title': '당신을 위한 최적의 컬러 파레트', 'js_guide_title': '추천 스타일링 & 매칭 가이드',
        'cam_capture_btn': '📸 사진 촬영 및 AI 분석하기', 'cam_loading': '⏳ AI가 실시간 피부 톤 분석 중...', 'cam_error': '카메라를 시작할 수 없습니다. 권한을 확인해 주시거나, 대신 [기존 사진 업로드] 기능을 사용해 주세요!',
    ...
    'en': {
        ...
        'upload_title': '📸 AI Smart Analysis (Beta)', 'upload_desc': 'Please use a well-lit front-facing photo for accurate analysis. No data leaves your device.', 
        'upload_btn': 'Activate Live Camera', 'file_select_btn': '📁 Upload Local Photo',
        'js_best_title': 'Best Color Palette for You', 'js_guide_title': 'Styling & Matching Guide',
        'cam_capture_btn': '📸 Take Photo & Analyze', 'cam_loading': '⏳ AI Analyzing Skin Tone...', 'cam_error': 'Cannot access camera. Please check browser permissions or upload an image file instead.',
    ...
    'ja': {
        ...
        'celeb_title': '👑 代表的なセレブ',
        'celeb_desc': '<li><span style="color:#ff7675;font-weight:bold;">イエベ春:</span> 本田翼, 石原さとみ</li><li><span style="color:#74b9ff;font-weight:bold;">ブルベ夏:</span> 新垣結衣, 綾瀬はるか</li><li><span style="color:#b2bec3;font-weight:bold;">イエベ秋:</span> 北川景子, 中村アン</li><li><span style="color:#6c5ce7;font-weight:bold;">ブルベ冬:</span> 小松菜奈, 菜々緒</li>',
        'quiz_main_title': '🎨 あなたのパーソナルカラー診断', 'quiz_main_desc': '簡単な視覚的な質問に答えて、あなたにぴったりのシーズンカラーを見つけてみましょう。',
        'start_btn_txt': '診断を始める', 'restart_btn_txt': 'もう一度診断する', 'result_main_title': '🎉 診断結果',
        'upload_title': '📸 AIスマート分析 (Beta)', 'upload_desc': '正確な分析のため、明るい場所で撮影された正面の写真を使用してください。データは保存されません。', 
        'upload_btn': 'カメラを起動する', 'file_select_btn': '📁 写真をアップロード',
        'js_best_title': 'あなたに最適なカラー', 'js_guide_title': 'スタイリングガイド',
        'cam_capture_btn': '📸 撮影してAI分析する', 'cam_loading': '⏳ AIが肌トーンを分析中...', 'cam_error': 'カメラを起動できません。権限を確認するか、写真をアップロードしてください。',
        ...
        'res_autumn': 'あなたは深くリッチで大人っぽい「イエベ秋」です！カーキやディープバーガンディなどのアースカラーが魅력을引き出します。',
    ...
    'es': {
        ...
        'celeb_title': '👑 Celebridades de Referencia',
        'celeb_desc': '<li><span style="color:#ff7675;font-weight:bold;">Primavera Cálida:</span> Ester Expósito, Belinda</li><li><span style="color:#74b9ff;font-weight:bold;">Verano Frío:</span> Úrsula Corberó, Aitana</li><li><span style="color:#b2bec3;font-weight:bold;">Otoño Cálido:</span> Penélope Cruz, Salma Hayek</li><li><span style="color:#6c5ce7;font-weight:bold;">Invierno Frío:</span> Rosalía, Georgina Rodríguez</li>',
        ...
        'upload_title': '📸 Análisis Inteligente IA (Beta)', 'upload_desc': 'Use una foto frontal bien iluminada para un análisis preciso. Ningún dato sale de su dispositivo.', 
        'upload_btn': 'Activar Cámara', 'file_select_btn': '📁 Subir Foto Local',
        'js_best_title': 'Tu Mejor Paleta de Colores', 'js_guide_title': 'Guía de Estilo',
        'cam_capture_btn': '📸 Capturar y Analizar con IA', 'cam_loading': '⏳ IA Analizando Tono de Piel...', 'cam_error': 'No se puede acceder a la cámara. Revisa los permisos o sube una foto.',
        'q1': '1. ¿Qué te queda mejor, accesorios de oro o plata?', 'a1_1': 'El oro hace que mi piel luce brillante.', 'a1_2': 'La plata me da un aspecto sofisticado.',
    ...
    'zh': {
        ...
        'upload_title': '📸 AI 智能分析 (Beta)', 'upload_desc': '请使用光线充足的正脸照片以确保分析准确。数据不会离开您的设备。', 
        'upload_btn': '启动相机拍照', 'file_select_btn': '📁 上传本地照片',
        'js_best_title': '最适合您的调色板', 'js_guide_title': '造型与搭配指南',
        'cam_capture_btn': '📸 拍照并进行 AI 分析', 'cam_loading': '⏳ AI 正在分析肤色...', 'cam_error': '无法访问相机，请检查权限，或直接上传本地照片。',
        'q1': '1. 金色和银色饰品，哪个更适合您？', 'a1_1': '金色让我的皮肤看起来明亮温暖。', 'a1_2': '银色让我的皮肤看起来干净通透。',
        'q2': '2. 长时间日晒后您的皮肤反应如何？', 'a2_1': '很容易晒黑。', 'a2_2': '很容易发红或晒伤。',
        'q3': '3. 您通常给人留下的第一印象是什么？', 'a3_1': '平静、柔和、温暖或亲切的形象。', 'a3_2': '清晰、干净、精致 or 干练的形象。',
        'q4': '4. 您的自然发色或瞳孔颜色更接近哪种？', 'a4_1': '柔和的棕色或浅暖棕色。', 'a4_2': '纯黑色或非常深的炭黑色。',
        'res_spring': '您拥有充满活力的温暖能量（春季暖色）！桃色 and 珊瑚色是您的最佳颜色。',
...
<head>
    ...
    <style>
        * {{ box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }}
        ...
        .upload-btn-group {{ display: block !important; margin-top: 15px !important; }}
        .action-btn {{ width: 100% !important; display: block !important; margin-bottom: 12px !important; text-align: center !important; }}
    </style>
</head>
<body>
    <div class="container">
            ...
            <div class="right-column">
                ...
                <section id="analysis-card-zone" class="card upload-card">
                    ...
                    <div class="upload-btn-group">
                        <button id="init-cam-btn" class="btn action-btn" style="background: linear-gradient(135deg, #74b9ff, #0984e3);">{upload_btn}</button>
                        <button id="trigger-file-btn" class="btn action-btn" style="background: linear-gradient(135deg, #a29bfe, #6c5ce7);">{file_select_btn}</button>
                    </div>
...
for folder, configs in lang_config.items():
    ...
    print(f"✅ {folder.upper()} 빌드 성공")

os.system("git add .")
os.system("git commit -m 'Fix: Robust implementation for camera and layout rendering'")
